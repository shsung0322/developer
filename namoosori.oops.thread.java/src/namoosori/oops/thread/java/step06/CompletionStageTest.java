...
class CompletionStageTest {
	...
	@Test
	public void testRunAnync() throws Exception {
		//
    ...
    @Test
    public void testAcceptEitherAsyncCallingFinishesFirst() throws Exception {
    		//
    ...
    @Test
    public void testAcceptEitherAsyncNestedFinishesFirst() throws Exception {
    ...
    @Test
    public void testAcceptBothAsync() throws Exception {
    		//
    ...
    public void testApply() throws Exception {
    		//
        CompletableFuture<String> task = CompletableFuture.supplyAsync(simulatedTask(1, "change me"), service)
    ...
    @Test
    public void testThenCombineWithOneSuppliedValue() throws Exception {
    		//
